...
public class Application extends javax.swing.JFrame {
    ...
    {//GEN-HEADEREND:event_jButtonWriteActionPerformed
        ...
        if (jCheckBoxWriteRemote.isSelected()) {
            enumType.add(TPCANMessageType.PCAN_MESSAGE_RTR);
        } else {
    ...
    {//GEN-HEADEREND:event_jCheckBoxWriteRemoteActionPerformed
        ...
        jCheckBoxWriteBrs.setEnabled(jCheckBoxWriteFd.isEnabled() && jCheckBoxWriteFd.isSelected());
    ...
    private void jButtonConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConnectActionPerformed
        ...
        if (res == TPCANStatus.PCAN_ERROR_OK || res == TPCANStatus.PCAN_ERROR_CAUTION) {
            item = new ChannelItem(channel, true);
            ...
            if (stsResult == TPCANStatus.PCAN_ERROR_OK) 
            {
                ...
                for(TPCANChannelInformation channel : info)
                {
                    if ((channel.getChannelCondition() & TPCANParameterValue.PCAN_CHANNEL_AVAILABLE.getValue()) == TPCANParameterValue.PCAN_CHANNEL_AVAILABLE.getValue())
                    {
                        ...
                        if ((protocol & CANProtocol.CAN_FD) != 0)
