...
/**
 * Represents a PCAN classic bit rate string. You can define your own bit rate 
 * with the CC string, as shown in this exemple: "f_clock_mhz=20, nom_brp=5,
 * nom_tseg1=2, nom_tseg2=1, nom_sjw=1"
 */
public class TPCANBitrateCC {
