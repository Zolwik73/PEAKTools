...
public enum TPCANParameterValue {
    ...
    PCAN_FILTER_OPEN(1),
    /**
     * The PCAN filter is custom configured. Only registered messages will be
     * received
     */
    ...
    /**
     * The PCAN-Channel handle is already being used by a PCAN-View application,
     * but is available to connect
     */
    ...
    /**
     * Causes using the data length column ('l') instead of the DLC column ('L')
     * in the trace file
     */
    TRACE_FILE_DATA_LENGTH(0x100),
    /**
    ...
    /**
     * Device supports I/O functionality for electronic circuits (USB-Chip
     * devices)
     */
    FEATURE_IO_CAPABLE(0x04),
    /**
     * Device supports the subsequent development of the classic CAN bus
     * (CAN-XL)
     */
    FEATURE_XL_CAPABLE(0x08),
    /**
     ...
     */
    LAN_DIRECTION_READ(0x01),
    /**
     * The PCAN-Channel is limited to outgoing communication only
     */
    LAN_DIRECTION_WRITE(0x02),
    /**
     * The PCAN-Channel communication is bidirectional
     */
    LAN_DIRECTION_READ_WRITE(LAN_DIRECTION_READ.value | LAN_DIRECTION_WRITE.value);
     ...
     */
    public static final int MAX_LENGTH_VERSION_STRING = 256;
    /**
     ...
     */
    public static final int MAX_LENGTH_DATA_XL = 2048;
    /**
     * Maximum value for a standard CAN ID of a CAN 2.0A/B / FD message
     */
    public static final int MAX_VALUE_STANDARD_ID = 0x7FF;
    /**
     * Maximum value for an extended CAN ID of a CAN 2.0A/B / FD message
     */
    public static final int MAX_VALUE_EXTENDED_ID = 0x1FFFFFFF;
    ...
    /**
     * Parses a int value into the TPCANParameterValue PCAN_PARAMETER_ON or
     * PCAN_PARAMETER_OFF
     *
    ...
    /**
     * Parses a int value into the TPCANParameterValue PCAN_CHANNEL_AVAILABLE,
     * PCAN_CHANNEL_ILLEGAL, PCAN_CHANNEL_OCCUPIED or PCAN_CHANNEL_UNOCCUPIED
     *
     * @param value parsed value
     * @return Corresponding TPCANParameterValue
     */
    ...
    /**
     * Parses a int value into the TPCANParameterValue PCAN_FILTER_CLOSE,
     * PCAN_FILTER_OPEN or PCAN_FILTER_CUSTOM.
     *
     * @param value parsed value
     * @return Corresponding TPCANParameterValue
     */
    ...
    static public EnumSet<TPCANParameterValue> parseFeatures(int value) {
        ...
        if ((value & TPCANParameterValue.FEATURE_XL_CAPABLE.getValue()) != 0) {
            result.add(TPCANParameterValue.FEATURE_XL_CAPABLE);
        }
        return result;
    }
