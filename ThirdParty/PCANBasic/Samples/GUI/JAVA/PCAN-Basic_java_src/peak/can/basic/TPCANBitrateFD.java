...
/**
 * FD bit rates for the CAN FD controller. You can define your own bit rate with
 * the FD string, as shown in this exemple: "f_clock_mhz=20, nom_brp=5,
 * nom_tseg1=2, nom_tseg2=1, nom_sjw=1, data_brp=2, data_tseg1=3, data_tseg2=1,
 * data_sjw=1"
 */
public class TPCANBitrateFD {
     ...
     *
     * @param value A CAN FD bitrate string (for instance: "f_clock_mhz=20,
     * nom_brp=5, nom_tseg1=2, nom_tseg2=1, nom_sjw=1, data_brp=2, data_tseg1=3,
     * data_tseg2=1, data_sjw=1")
     */
