...
using TPCANTimestamp = System.UInt64;
...
namespace ICDIBasic
{
    public partial class Form1 : Form
    {
        ...
        private static string FormatChannelName(TPCANHandle handle, CANProtocol protocol = CANProtocol.CAN)
        {
        ...
        private void InsertMsgEntry(TPCANMsg newMsg, TPCANTimestamp timeStamp)
        {
            ...
            lock (m_LastMsgsList.SyncRoot)
            {
                ...
                {
                    ShowingPeriod = chbShowPeriod.Checked
                };
        ...
        {
            TPCANTimestamp timestamp = itsTimeStamp.micros + (1000UL * itsTimeStamp.millis) + (0x100_000_000UL * 1000UL * itsTimeStamp.millis_overflow);
        ...
        private void cbbParameter_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //
            rdbParamActive.Enabled = (cbbParameter.SelectedIndex != 0) && (cbbParameter.SelectedIndex != 18);
            ...
            laDeviceOrDelay.Text = (cbbParameter.SelectedIndex == 18) ? "Delay (μs):" : "Device ID (Hex):";
        ...
        private void btnParameterGet_Click(object sender, EventArgs e)
        {
            ...
            switch (cbbParameter.SelectedIndex)
            {
                ...
                //
                case 11:
                    stsResult = PCANBasic.GetValue(m_PcanHandle, TPCANParameter.PCAN_BITRATE_INFO_BTR, out iBuffer, sizeof(UInt32));
                    if (stsResult == TPCANStatus.PCAN_ERROR_OK)
        ...
        private void nudLength_ValueChanged(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                TextBox txtbCurrentTextBox = (TextBox)this.Controls.Find("txtData" + i.ToString(), true)[0];
