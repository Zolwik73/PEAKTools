...
Imports TPCANTimestamp = System.UInt64
...
#Region "Structures"
    ...
    Private Class MessageStatus
        ...
        Private Function GetMsgTypeString() As String
            ...
            Dim isEcho As Boolean = (m_Msg.MSGTYPE And TPCANMessageType.PCAN_MESSAGE_ECHO) = TPCANMessageType.PCAN_MESSAGE_ECHO
...
#Region "UI Handler"
            ...
            If (stsResult = TPCANStatus.PCAN_ERROR_OK) Then
                ...
                If (stsResult = TPCANStatus.PCAN_ERROR_OK) Then
                    ...
                    For Each channel As TPCANChannelInformation In info
                        If ((channel.channel_condition And PCANBasic.PCAN_CHANNEL_AVAILABLE) = PCANBasic.PCAN_CHANNEL_AVAILABLE) Then
    ...
    Private Sub cbbParameter_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbbParameter.SelectedIndexChanged
        ...
        '
        rdbParamActive.Enabled = (cbbParameter.SelectedIndex <> 0) And (cbbParameter.SelectedIndex <> 18)
        ...
        laDeviceOrDelay.Text = If((cbbParameter.SelectedIndex = 18), "Delay (μs):", "Device ID (Hex):")
    ...
    Private Sub btnParameterGet_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnParameterGet.Click
        ...
        Select Case cbbParameter.SelectedIndex
            ...
            Case 10
                ...
                '
            Case 11
                stsResult = PCANBasic.GetValue(m_PcanHandle, TPCANParameter.PCAN_BITRATE_INFO_BTR, iBuffer, CType(System.Runtime.InteropServices.Marshal.SizeOf(iBuffer), UInteger))
                If stsResult = TPCANStatus.PCAN_ERROR_OK Then
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As KeyPressEventArgs) Handles txtID.KeyPress, txtData7.KeyPress, txtData6.KeyPress, txtData5.KeyPress, txtData4.KeyPress, txtData3.KeyPress, txtData2.KeyPress, txtData1.KeyPress, txtData0.KeyPress
    ...
    Private Sub txtData0_Leave(ByVal sender As Object, ByVal e As EventArgs) Handles txtData7.Leave, txtData6.Leave, txtData5.Leave, txtData4.Leave, txtData3.Leave, txtData2.Leave, txtData1.Leave, txtData0.Leave
        Dim txtbCurrentTextbox As TextBox
...
#Region "Help functions"
    ...
    Private Function FormatChannelName(ByVal handle As TPCANHandle, ByVal protocol As CANProtocol) As String
        ...
        '
        Dim stringFormat As String = "{0}:{1} {2} ({3:X2}h)"
        Dim bIsXL As Boolean = (protocol And CANProtocol.CAN_XL) = CANProtocol.CAN_XL
        Dim bIsFd As Boolean = (protocol And CANProtocol.CAN_FD) = CANProtocol.CAN_FD
...
#Region "Message-proccessing functions"
    ...
    Private Sub ProcessMessage(ByVal theMsg As TPCANMsg, ByVal itsTimeStamp As Peak.Can.Basic.TPCANTimestamp)
        Dim timestamp As ULong = itsTimeStamp.micros + (1000UL * itsTimeStamp.millis) + (&H100000000UL * 1000UL * itsTimeStamp.millis_overflow)
    ...
    Private Function ReadMessage() As TPCANStatus
        ...
        Dim CANTimeStamp As Peak.Can.Basic.TPCANTimestamp
        Dim stsResult As TPCANStatus
