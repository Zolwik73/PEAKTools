...
#Region "Structures"
    ...
    Private Class MessageStatus
        ...
        Private Function GetDataString() As String
            ...
            strTemp = ""
            For i As Integer = 0 To Form1.GetLengthFromDLC(m_Msg.DLC) - 1
...
#Region "Members"
    ...
    ''' <summary>
    ''' Controls whether the message-reading thread is running or not
    ''' </summary>
...
#Region "UI Handler"
                ...
                If (stsResult = TPCANStatus.PCAN_ERROR_OK) Then
                    ...
                    For Each channel As TPCANChannelInformation In info
                        ...
                        If ((channel.channel_condition And PCANBasic.PCAN_CHANNEL_AVAILABLE) = PCANBasic.PCAN_CHANNEL_AVAILABLE And
                            (protocol And CANProtocol.CAN_FD) = CANProtocol.CAN_FD) Then
    ...
    Private Sub cbbParameter_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbbParameter.SelectedIndexChanged
        ...
        '
        rdbParamActive.Enabled = (cbbParameter.SelectedIndex <> 0) And (cbbParameter.SelectedIndex <> 20)
        ...
        laDeviceOrDelay.Text = If((cbbParameter.SelectedIndex = 20), "Delay (μs):", "Device ID (Hex):")
    ...
    Private Function WriteFrameFD()
        ...
        CANMsg.MSGTYPE = CANMsg.MSGTYPE Or If(chbExtended.Checked, TPCANMessageType.PCAN_MESSAGE_EXTENDED, TPCANMessageType.PCAN_MESSAGE_STANDARD)
    ...
    Private Sub nudLength_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles nudLength.ValueChanged
        ...
        iLength = GetLengthFromDLC(nudLength.Value)
...
#Region "Help functions"
    ...
    Public Shared Function GetLengthFromDLC(ByVal dlc As Integer)
        If dlc <= 8 Then
            Return dlc
        End If
