...
// Function pointers
//
typedef TPCANStatus(__stdcall* fpInitialize)(TPCANHandle, TPCANBaudrate, DWORD, WORD);
typedef TPCANStatus(__stdcall* fpInitializeFD)(TPCANHandle, TPCANBitrateFD);
typedef TPCANStatus(__stdcall* fpInitializeXL)(TPCANHandle, TPCANBitrateXL);
...
typedef TPCANStatus(__stdcall* fpReadXL)(TPCANHandle, TPCANMsgXL*, TPCANTimestampXL*);
typedef TPCANStatus(__stdcall* fpWriteFD)(TPCANHandle, TPCANMsgFD*);
typedef TPCANStatus(__stdcall* fpWriteXL)(TPCANHandle, TPCANMsgXL*);
...
private:
	...
	//Function pointers
	fpInitializeXL m_pInitializeXL;
...
public:
	...
	TPCANStatus Initialize(TPCANHandle Channel, TPCANBaudrate Btr0Btr1, DWORD IOPort = 0, WORD Interrupt = 0);
	...
	/// <returns>A TPCANStatus error code</returns>
	TPCANStatus InitializeXL(TPCANHandle Channel, TPCANBitrateXL BitrateXL);
	...
	/// should be passed as NULL</param>
	/// <returns>A TPCANStatus error code</returns>
	TPCANStatus ReadXL(TPCANHandle Channel, TPCANMsgXL* MessageBuffer, TPCANTimestampXL* TimestampBuffer);
	...
	/// <returns>A TPCANStatus error code</returns>
	TPCANStatus WriteXL(TPCANHandle Channel, TPCANMsgXL* MessageBuffer);
