...
################################################################################################################################################
    ...
    def InitializeBasicComponents(self):
        ...
        if IS_WINDOWS:
            self.m_PARAMETERS = {'Device ID':PCAN_DEVICE_ID, '5V Power':PCAN_5VOLTS_POWER,
                                 ...
                                 'Bit rate Adaptation':PCAN_BITRATE_ADAPTING,'Get Bit rate BTR Information':PCAN_BITRATE_INFO_BTR,
                                 'Get CAN Nominal Speed Bit/s':PCAN_BUSSPEED_NOMINAL,'Get IP Address':PCAN_IP_ADDRESS,
    ...
    def InitializeWritingWidgets(self):
        ...
        Label(self.gbWriting, width=38,anchor=W, text="").grid(row=0, padx = 0, column=8, sticky=W)
