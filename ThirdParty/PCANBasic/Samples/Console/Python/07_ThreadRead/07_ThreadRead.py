...
class ThreadRead():
    ...
    def __init__(self):
        ...
        print("")
        self.getInput("Press <Enter> to stop thread...")
    ...
    def ProcessMessageCan(self,msg,itstimestamp):
         ...
         print("\nType: " + self.GetTypeString(msg.MSGTYPE))
    ...
    def ProcessMessageCanXl(self,msg,itstimestamp):
        ...
        Parameters:
            ...
            itstimestamp = Timestamp of the message as microseconds (ulong)
        """        
        print("\nType: " + self.GetTypeStringXL(msg.MSGTYPE, msg.RRS, msg.SEC))
    ...
    def ShowConfigurationHelp(self):
        ...
        """
        print("=========================================================================================")
        print("|                        PCAN-Basic ThreadRead Example                                   |")
        print("=========================================================================================")
