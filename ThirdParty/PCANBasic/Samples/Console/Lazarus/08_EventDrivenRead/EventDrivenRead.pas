...
begin
  ...
  stsResult := TPCANBasic.SetValue(FPcanHandle, TPCANParameter.PCAN_RECEIVE_EVENT, PLongWord(@m_hEvent),SizeOf(m_hEvent));
  ...
  //
  dwTemp := 0;
  TPCANBasic.SetValue(FPcanHandle, TPCANParameter.PCAN_RECEIVE_EVENT, PLongWord(@dwTemp), SizeOf(dwTemp));
end;
