...
void PCANBasicClass::LoadAPI()
{
    ...
    m_bWasLoaded = m_pInitialize && m_pUnInitialize && m_pReset &&
        m_pGetStatus && m_pRead && m_pWrite && m_pFilterMessages &&
        ...
        TPCANBaudrate Btr0Btr1)
{
    ...
    return (TPCANStatus)m_pInitialize(Channel, Btr0Btr1, NULL, NULL, NULL);
}
