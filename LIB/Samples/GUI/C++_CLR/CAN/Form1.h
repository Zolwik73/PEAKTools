...
namespace PCANBasicExample 
{
	...
	typedef System::UInt64 TPCANTimestamp;
	...
	public value class MessageStatus 
	{
		...
		public: void 
			Update(TPCANMsg ^canMsg, TPCANTimestamp canTimestamp)
            {
                m_Msg = *canMsg;
		...
		public: 
			property TPCANMsg CANMsg
            {
                TPCANMsg get() { return m_Msg; }
            }

		public: 
			property TPCANTimestamp Timestamp
            {
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lstMessages->Size = System::Drawing::Size(554, 96);
			...
			this->lbxInfo->Size = System::Drawing::Size(552, 56);
			...
			this->groupBox6->Size = System::Drawing::Size(710, 95);
			...
			this->btnWrite->Location = System::Drawing::Point(639, 64);
			...
			this->groupBox4->Location = System::Drawing::Point(12, 458);
			this->groupBox4->Name = L"groupBox4";
			this->groupBox4->Size = System::Drawing::Size(710, 93);
			...
			this->btnReset->Location = System::Drawing::Point(639, 52);
			...
			this->btnStatus->Location = System::Drawing::Point(568, 52);
			...
			this->nudDeviceIdOrDelay->Hexadecimal = true;
			...
			this->laDeviceOrDelay->Size = System::Drawing::Size(92, 23);
			...
			this->cbbParameter->Items->AddRange(gcnew cli::array< System::Object^  >(23) {
				L"Device ID", L"5V Power", L"Auto-reset on BUS-OFF",
					...
					L"Channel Capabilities", L"Bit rate Adaptation", L"Get Bit rate BTR Information", L"Get CAN Nominal Speed Bit/s", L"Get IP Address",
					L"Get LAN Service Status", L"Reception of Status Frames", L"Reception of RTR Frames", L"Reception of Error Frames", L"Interframe Transmit Delay",
					L"Reception of Echo Frames", L"Hard Reset Status", L"Communication Direction", L"Global Unique Identifier (GUID)"
			});
			...
			this->ClientSize = System::Drawing::Size(734, 556);
...
#pragma region Members
	private:
		...
		/// <summary>
		/// Flag for message reading thread (using events)
		/// </summary>
...
#pragma region Message-proccessing functions
	...
	{
		TPCANMsg ^CANMsg;
		Peak::Can::Basic::TPCANTimestamp ^CANTimeStamp;
		TPCANStatus ^stsResult;

        // We execute the "Read" function of the PCANBasic                
        //
		CANMsg = gcnew TPCANMsg();
		CANTimeStamp = gcnew Peak::Can::Basic::TPCANTimestamp();
	...
	private: void ProcessMessage(TPCANMsg ^theMsg, Peak::Can::Basic::TPCANTimestamp ^itsTimeStamp)
    {
		TPCANTimestamp timestamp = itsTimeStamp->micros + (1000UL * itsTimeStamp->millis) + (0x100000000UL * 1000UL * itsTimeStamp->millis_overflow);
...
#pragma region Event Handlers
	...
	private: System::Void cbbParameter_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e) 
	{
		...
		//
		rdbParamActive->Enabled = ((dynamic_cast<ComboBox^>(sender))->SelectedIndex != 0) && ((dynamic_cast<ComboBox^>(sender))->SelectedIndex != 18);
		...
		laDeviceOrDelay->Text = (cbbParameter->SelectedIndex == 18) ? "Delay (\u00B5s):" : "Device ID (Hex):";
		nudDelay->Visible = cbbParameter->SelectedIndex == 18;
		nudDeviceIdOrDelay->Visible = !nudDelay->Visible;
	}
	...
	private: System::Void btnParameterGet_Click(System::Object^  sender, System::EventArgs^  e) 
	{
		...
		switch (cbbParameter->SelectedIndex)
		{
            ...
            //
            case 11:
				stsResult = PCANBasic::GetValue(*m_PcanHandle, TPCANParameter::PCAN_BITRATE_INFO_BTR, iBuffer, sizeof(UInt32));
				if (*stsResult == TPCANStatus::PCAN_ERROR_OK)
	...
	private: System::Void nudLength_ValueChanged(System::Object^  sender, System::EventArgs^  e) 
	{
		...
		for(int i = 0; i < 8; i++)
		{
			TextBox ^CurrentTextBox = safe_cast<TextBox^>(this->Controls->Find("txtData" + i.ToString(), true)[0]);
