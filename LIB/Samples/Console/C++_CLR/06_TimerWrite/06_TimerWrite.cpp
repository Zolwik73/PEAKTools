...
private:
    ...
    void SetTimer()
    {
        ...
        m_Timer->Elapsed += gcnew ElapsedEventHandler(this, &TimerWrite::OnTimedEvent); // Hook up the Elapsed event for the timer. 
...
{
    TimerWrite^ start = gcnew TimerWrite();
    return 0;
}
